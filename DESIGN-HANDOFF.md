# 6c13ea5c-f7df-4a7b-a352-2913af5951f4 implementation handoff
...
## Entry points
- `index.html`
- `revisioni/index-v2.html`

## Styles
- `revisioni/style-v2.css`
- `style-v2.css`
- `style.css`
...
- `polish-accesso.png`
- `README.md`
- `revisioni/brand-spec-v2.md`
- `verifica-dashboard.png`
- `verifica-frontend.md`
