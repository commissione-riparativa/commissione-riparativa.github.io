...
- Spaziatura: scala 4, 8, 12, 16, 20, 24, 32 e 40 px; involucro massimo 1440 px, navigazione desktop 232 px e spazio tra colonne 40 px.
...
- Campi: altezza minima 50 px; select di stato 44 px. Focus esterno da 3 px con contrasto interno chiaro anche sui pulsanti pieni.
- Filtri: controlli compatti con conteggio tabellare, etichetta testuale e sottolineatura di selezione.
